...
with DAG(
    ...
    t10_trigger_landing = TriggerDagRunOperator(
        ...
        trigger_run_id="daily_landing__{{ trigger_run_suffix(dag_run) }}",
    ...
    t20_trigger_dbt_transform = TriggerDagRunOperator(
        ...
        trigger_run_id="daily_dbt__{{ trigger_run_suffix(dag_run) }}",
        conf=daily_child_conf(),
        logical_date="{{ trigger_logical_date(dag_run) }}",
        wait_for_completion=True,
        deferrable=True,
    ...
    t30_trigger_quality_alerts = TriggerDagRunOperator(
        ...
        trigger_run_id="daily_quality__{{ trigger_run_suffix(dag_run) }}",
        conf=daily_child_conf(),
        logical_date="{{ trigger_logical_date(dag_run) }}",
        wait_for_completion=True,
        deferrable=True,
    ...
    t40_trigger_agentic_triage = TriggerDagRunOperator(
        ...
        trigger_run_id="daily_triage__{{ trigger_run_suffix(dag_run) }}",
        conf=daily_child_conf(),
        logical_date="{{ trigger_logical_date(dag_run) }}",
        wait_for_completion=True,
        deferrable=True,
